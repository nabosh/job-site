            ...
            <div className='relative flex-grow pt-3'>
              <div className='relative  '>
                <p className='text-center '>
                  <strong>iCIMS INC </strong>&middot; Holmdel, NJ &middot;
                  9/2021 to Present
                </p>
                <p className='text-center'>
                ...
                <div className='pt-6 relative'>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li className='list-disc'>
                      ...
                      from Twilio, Google, USPS, and InfusionSoft) and
                      engineered company&rsquo;s transition to it from Mobit,
                      resulting in far greater customization capability and
                  ...
                  <p className='pt-6 text-center'>
                    <strong>ARISTOTLE </strong>&middot; Provo, UT &middot;
                    5/2017 to 10/2018; 4/2015 to 3/2017
                  </p>
                  <p className='text-center'>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li className='list-disc'>
                      ...
                      development, onboarding and customer training for
                      full-service, global organization providing a vast
                      spectrum of products, services and solutions for political
                    ...
                    <li className='list-disc'>
                      ...
                      Team; expanded identity verification service from five
                      days per week to six while remaining within budget; served
                      as direct and primary point of contact for all identity
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li className='list-disc'>
                      Exemplary performance in this role resulted in being
                      rehired and promoted by company to a management position
